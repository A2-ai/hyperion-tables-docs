...
description: "Creates rules for filtering which parameters appear in the output table. Rules are evaluated after name transformation."
pagefind: true
---
...
<tr>
<td><code>...</code></td>
<td>Filter expressions like `!fixed`, `diagonal`</td>
</tr>
</tbody>
</table>
</div>
