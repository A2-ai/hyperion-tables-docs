...
<tr>
<td><code>...</code></td>
<td>Formula expressions following [`dplyr::case_when()`](https://dplyr.tidyverse.org/reference/case_when.html)<span style = {{ display: 'inline-block', verticalAlign: 'middle' }}><Icon name="external" /></span> syntax, `kind == "THETA" ~ "Structural Parameters"`</td>
</tr>
</tbody>
</table>
</div>
