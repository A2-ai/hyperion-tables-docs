...
description: "Creates rules for filtering which models appear in the summary table. Rules are evaluated against the summary data frame."
pagefind: true
---
...
<tr>
<td><code>...</code></td>
<td>Filter expressions like `"final" %in% tags`, `!is.null(description)`</td>
</tr>
</tbody>
</table>
</div>
